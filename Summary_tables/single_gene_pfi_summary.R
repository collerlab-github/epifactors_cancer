...
for (c in cancer_list) {
  ...
  cancer_file <- paste0('../',project,'_',c,'/05_gene_clinical_prediction_analysis/',c,'_significant_pval_differential_genes_',end,'.csv')
  ...
  pro_file <- paste0('../',project,'_',c,'/05_gene_clinical_prediction_analysis/',end,'_promoting_genes_protein_complexes.csv')
  inh_file <- paste0('../',project,'_',c,'/05_gene_clinical_prediction_analysis/',end,'_inhibiting_genes_protein_complexes.csv')
